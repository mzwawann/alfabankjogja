<x-layout>
    ...
    <div class="space-x-2">
        <div id="block-26" class="widget footer-widget widget_block items-center inline-block p-2" style="width:100%;">
            <iframe
        ...
        <div class="items-center inline-block p-4">
            <a href="https://maps.app.goo.gl/K6JwmzKfu2N8qdXf7" target="tab" class="flex items-center space-x-8 mb-4">
            ...
            <a href="https://wa.me/6289671481943" target="tab" class="flex items-center space-x-8 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 1219.547 1225.016"
                    id="whatsapp">
                    <path fill="#E0E0E0"
    ...
    <div class="flex flex-row space-x-2 items-center p-4">
        ...
        <a href="https://www.facebook.com/kursussingkatjogja?_rdc=2&_rdr" target="tab" class="flex item-center">
        ...
        <a href="https://www.youtube.com/channel/UCmdACoNxvMl0knnavhBGAxA" target="tab" class="flex item-center">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40"
                viewBox="0 0 48 48">
                <path fill="#FF3D00"
