<x-layout>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6 z-10">
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            placeholder="search article" type="search" id="serch" name="search"
                            autocomplete="off">
                        </input>
                    </div>
                    <div>
                        <button type="submit"
                            ...
                            <span class="lg:hidden capitalize">search</span>
                            <svg class="w-5 h-5 text-white hidden lg:block" aria-hidden="true"
    ...
    <div class="py-4 my-4 px-4 mx-auto max-w-screen-xl lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                    <div class="flex justify-between items-center mb-5 text-gray-500 capitalize">
                    ...
                    <p class="mb-5 font-light text-gray-500">{{ Str::limit($post->body, 90) }}</p>
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/posts/{{ $post->slug }}"
                            class="inline-flex items-center font-medium text-primary-600 hover:underline text-xs">
                            Read more
            ...
            @empty
                <div
                    class="grid place-items-center absolute top-1/2 text-center left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-1">
                    <div class="text-center">
                        <p class="capitalize font-semibold text-xl my-4">article not found!</p>
